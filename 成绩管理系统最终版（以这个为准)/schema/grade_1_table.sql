...
CREATE TABLE IF NOT EXISTS course_plan  (
    cou_plan_sn INTEGER,     -- 课程序号
    sch_term     TEXT,        --学期   
    cou_plan_name   TEXT,    ---课程名
    cou_plan_time  TEXT,        --时间
    cou_plan_place  TEXT,        --地点
    PRIMARY KEY(cou_plan_sn)
);


ALTER TABLE course_plan
    ADD CONSTRAINT cou_plan_sn_fk FOREIGN KEY (cou_plan_sn) REFERENCES course(sn);
